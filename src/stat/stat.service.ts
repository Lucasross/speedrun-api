...
export class StatService {
    ...
    async seed() {
        ...
        await this.statModel.insertMany([
            ...
            { name: 'Base Damage', description: 'Base damage of the job.', type: 'common', usages: ['job', 'monster'], weight: 1, default: 20 },
            { name: 'Base Mana', description: 'Base mana of the job.', type: 'common', usages: ['job', 'monster'], weight: 0.8, default: 0 },
            { name: 'Health', description: 'Flat increase to health.', type: 'common', usages: ['skill'], weight: 1, default: 0 },
            { name: 'Health %', description: 'Percentage increase to health.', type: 'common', usages: ['job', 'skill'], weight: 1, default: 0 },
            { name: 'Damage', description: 'Flat increase to overall damage.', type: 'common', usages: ['skill'], weight: 2, default: 0 },
            { name: 'Damage %', description: 'Percentage increase to overall damage.', type: 'common', usages: ['job', 'skill'], weight: 2, default: 0 },

            // ================ PHYSICAL ================= 18
            { name: 'Critical Chance %', description: 'Percentage of chance to deal a critical hit.', type: 'physical', usages: ['job', 'skill', 'monster'], weight: 3.5, default: 0 },
            { name: 'Critical Damage %', description: 'Flat bonus in percent to critical hit damage.', type: 'physical', usages: ['job', 'skill', 'monster'], weight: 1.5, default: 0 },
            { name: 'Attack Speed %', description: 'Flat bonus in percent to attack speed.', type: 'physical', usages: ['job', 'skill', 'monster'], weight: 2, default: 0 },
            { name: 'Double Hit %', description: 'Percentage of chance to perform an additional hit.', type: 'physical', usages: ['job', 'skill', 'monster'], weight: 2, default: 0 },
            { name: 'Heavy Damage', description: 'Flat bonus to physical hit damage.', type: 'physical', usages: ['skill', 'monster'], weight: 1.5, default: 0 },
            { name: 'Heavy Damage %', description: 'Percentage increase to physical damage.', type: 'physical', usages: ['job', 'skill'], weight: 2, default: 0 },
            { name: 'Swift Damage', description: 'Flat bonus to physical hit damage.', type: 'physical', usages: ['skill', 'monster'], weight: 1.5, default: 0 },
            { name: 'Swift Damage %', description: 'Percentage increase to physical damage.', type: 'physical', usages: ['job', 'skill'], weight: 2, default: 0 },
            { name: 'Physical Resistance', description: 'Flat reduction to physical damage taken.', type: 'physical', usages: ['skill', 'monster'], weight: 1, default: 0 },
            ...
            { name: 'Dodge %', description: 'Percentage of chance to evade an attack.', type: 'physical', usages: ['job', 'skill', 'monster'], weight: 1.5, default: 0 },
            { name: 'Block %', description: 'Percentage of chance to block an attack.', type: 'physical', usages: ['job', 'skill', 'monster'], weight: 1.5, default: 0 },
            { name: 'Thorns', description: 'Flat amount of damage reflected to attackers.', type: 'physical', usages: ['skill', 'monster'], weight: 1.5, default: 0 },
            { name: 'Thorns %', description: 'Percentage of damage reflected to attackers.', type: 'physical', usages: ['job', 'skill'], weight: 3, default: 0 },

            // ================ MAGIC ==================== 30
            { name: 'Mana', description: 'Flat increase to maximum mana.', type: 'magic', usages: ['skill', 'monster'], weight: 0.5, default: 0 },
            { name: 'Mana %', description: 'Percentage increase to maximum mana.', type: 'magic', usages: ['job', 'skill'], weight: 1, default: 0 },
            { name: 'Magic Damage', description: 'Flat increase to all magic damage.', type: 'magic', usages: ['skill', 'monster'], weight: 3.5, default: 0 },
            { name: 'Magic Damage %', description: 'Percentage increase to all magic damage.', type: 'magic', usages: ['job', 'skill'], weight: 5, default: 0 },
            { name: 'Fire Damage', description: 'Flat increase to fire damage.', type: 'magic', usages: ['skill', 'monster'], weight: 2, default: 0 },
            { name: 'Fire Damage %', description: 'Percentage increase to fire damage.', type: 'magic', usages: ['job', 'skill'], weight: 2.5, default: 0 },
            { name: 'Water Damage', description: 'Flat increase to water damage.', type: 'magic', usages: ['skill', 'monster'], weight: 2, default: 0 },
            { name: 'Water Damage %', description: 'Percentage increase to water damage.', type: 'magic', usages: ['job', 'skill'], weight: 2.5, default: 0 },
            { name: 'Earth Damage', description: 'Flat increase to earth damage.', type: 'magic', usages: ['skill', 'monster'], weight: 2, default: 0 },
            { name: 'Earth Damage %', description: 'Percentage increase to earth damage.', type: 'magic', usages: ['job', 'skill'], weight: 2.5, default: 0 },
            { name: 'Wind Damage', description: 'Flat increase to wind damage.', type: 'magic', usages: ['skill', 'monster'], weight: 2, default: 0 },
            { name: 'Wind Damage %', description: 'Percentage increase to wind damage.', type: 'magic', usages: ['job', 'skill'], weight: 2.5, default: 0 },
            { name: 'Light Damage', description: 'Flat increase to light damage.', type: 'magic', usages: ['skill', 'monster'], weight: 2, default: 0 },
            { name: 'Light Damage %', description: 'Percentage increase to light damage.', type: 'magic', usages: ['job', 'skill'], weight: 2.5, default: 0 },
            { name: 'Shadow Damage', description: 'Flat increase to shadow damage.', type: 'magic', usages: ['skill', 'monster'], weight: 2, default: 0 },
            { name: 'Shadow Damage %', description: 'Percentage increase to shadow damage.', type: 'magic', usages: ['job', 'skill'], weight: 2.5, default: 0 },
            { name: 'Magic Resistance', description: 'Flat reduction to magic damage taken.', type: 'magic', usages: ['skill', 'monster'], weight: 2.5, default: 0 },
            ...
            { name: 'Fire Resistance', description: 'Flat reduction to fire damage taken.', type: 'magic', usages: ['skill', 'monster'], weight: 1.3, default: 0 },
            ...
            { name: 'Water Resistance', description: 'Flat reduction to water damage taken.', type: 'magic', usages: ['skill', 'monster'], weight: 1.3, default: 0 },
            ...
            { name: 'Earth Resistance', description: 'Flat reduction to earth damage taken.', type: 'magic', usages: ['skill', 'monster'], weight: 1.3, default: 0 },
            ...
            { name: 'Wind Resistance', description: 'Flat reduction to wind damage taken.', type: 'magic', usages: ['skill', 'monster'], weight: 1.3, default: 0 },
            ...
            { name: 'Light Resistance', description: 'Flat reduction to light damage taken.', type: 'magic', usages: ['skill', 'monster'], weight: 1.3, default: 0 },
            ...
            { name: 'Shadow Resistance', description: 'Flat reduction to shadow damage taken.', type: 'magic', usages: ['skill', 'monster'], weight: 1.3, default: 0 },
            ...
            // ================ REGENERATION ============= 8
            { name: 'Life Regeneration', description: 'Flat health restored over time.', type: 'regeneration', usages: ['skill'], weight: 5, default: 0 },
            ...
            { name: 'Life Steal', description: 'Flat health stolen on hit.', type: 'regeneration', usages: ['skill'], weight: 4, default: 0 },
            ...
            { name: 'Mana Regeneration', description: 'Flat mana restored over time.', type: 'regeneration', usages: ['skill'], weight: 4, default: 0 },
            ...
            { name: 'Mana Steal', description: 'Flat mana stolen on hit.', type: 'regeneration', usages: ['skill'], weight: 2, default: 0 },
